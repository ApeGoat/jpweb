...
export default function Home() {
 ...
 return <main className="home-page">
  <section id="home" className="hero-section"><img className="hero-workmark" src={`${process.env.PUBLIC_URL}/jp-workmark.svg`} alt="" aria-hidden="true"/><h1 className="sr-only">{hero.name} — {hero.title}. {hero.motto}</h1></section>
